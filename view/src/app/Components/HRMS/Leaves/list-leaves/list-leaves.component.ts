...
export class ListLeavesComponent implements OnInit {
   ...
   constructor(
      ...
      Info = Info.toString();
      // get Leaves List
      this.Hrms_Service.HrmsLeaves_List({'Info': Info}).subscribe( response => {
   ...
   ActionIndex(_index) {
      this.Leaves_Id = (this.Active_Tab === 'other_request') ? this._OtherList[_index]._id : this._MyList[_index]._id;
   ...
   View() {
      this.router.navigate(['View_Leaves', this.Leaves_Id]);
   }
   Request() {
      const initialState = {
      ...
      this.bsModalRef.content.onClose.subscribe(u => {
         if (this.Active_Tab === 'other_request') {
            const i =  this._OtherList.findIndex(x => (x._id === this.Leaves_Id ));
            this._OtherList[i].Leaves_Status = 'Requested';
            this._OtherList[i].Status = 'Requested';
         } else {
            const i =  this._MyList.findIndex(x => (x._id === this.Leaves_Id ));
            this._MyList[i].Leaves_Status = 'Requested';
   ...
   Modify() {
      ...
      this.bsModalRef.content.onClose.subscribe(u => {
         if (this.Active_Tab === 'other_request') {
            const i =  this._OtherList.findIndex(x => (x._id === this.Leaves_Id ));
            this._OtherList[i].Leaves_Status = 'Modify';
            this._OtherList[i].Status = 'Modify';
         } else {
            const i =  this._MyList.findIndex(x => (x._id === this.Leaves_Id ));
            this._MyList[i].Leaves_Status = 'Modify';
   ...
   Approve() {
      ...
      this.bsModalRef.content.onClose.subscribe(u => {
         if (this.Active_Tab === 'other_request') {
            const i =  this._OtherList.findIndex(x => (x._id === this.Leaves_Id ));
            this._OtherList[i].Leaves_Status = 'Approved';
            this._OtherList[i].Status = 'Approved';
         } else {
            const i =  this._MyList.findIndex(x => (x._id === this.Leaves_Id ));
            this._MyList[i].Leaves_Status = 'Approved';
   ...
   Reject() {
      ...
      this.bsModalRef.content.onClose.subscribe(u => {
         if (this.Active_Tab === 'other_request') {
            const i =  this._OtherList.findIndex(x => (x._id === this.Leaves_Id ));
            this._OtherList[i].Leaves_Status = 'Rejected';
            this._OtherList[i].Status = 'Rejected';
         } else {
            const i =  this._MyList.findIndex(x => (x._id === this.Leaves_Id ));
            this._MyList[i].Leaves_Status = 'Rejected';
