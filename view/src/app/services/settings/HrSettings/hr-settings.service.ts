...
const API_URL = 'http://localhost:3000/API/Hr_Settings/';
...
export class HrSettingsService {
  ...
  ValidateEveryRequest() {
   ...
   // Employee Category
      public Employeecategory_AsyncValidate(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
        return this.http.post(API_URL + 'Employeecategory_AsyncValidate', Info, {headers: this.headers })
      ...
      public Employee_category_Create(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
         return this.http.post(API_URL + 'Employee_category_Create', Info, {headers: this.headers })
         .pipe( map(response => response),  catchError(error => of(error)));
      } else {
        return this.ValidateEveryRequest();
     }
      ...
      public Employee_category_List(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
         return this.http.post(API_URL + 'Employee_category_List', Info, {headers: this.headers })
         .pipe( map(response => response), catchError(error => of(error)));
      } else {
        return this.ValidateEveryRequest();
     }
      ...
      public Employee_category_SimpleList(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
         return this.http.post(API_URL + 'Employee_category_SimpleList', Info, {headers: this.headers })
         .pipe( map(response => response),  catchError(error => of(error)));
      } else {
        return this.ValidateEveryRequest();
     }
      ...
      public Employee_category_Update(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
         return this.http.post(API_URL + 'Employee_category_Update', Info, {headers: this.headers })
         .pipe( map(response => response), catchError(error => of(error)));
      } else {
        return this.ValidateEveryRequest();
     }
      ...
      public Employee_category_Delete(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
         return this.http.post(API_URL + 'Employee_category_Delete', Info, {headers: this.headers })
         .pipe( map(response => response),  catchError(error => of(error)));
      } else {
        return this.ValidateEveryRequest();
     }
   ...
   // Department
      public Department_AsyncValidate(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
        return this.http.post(API_URL + 'Department_AsyncValidate', Info, {headers: this.headers })
        .pipe( map(response => response),  catchError(error => of(error)));
    } else {
      return this.ValidateEveryRequest();
   }
      ...
      public Department_Create(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
         return this.http.post(API_URL + 'Department_Create', Info, {headers: this.headers })
         .pipe( map(response => response),  catchError(error => of(error)));
      } else {
        return this.ValidateEveryRequest();
     }
      ...
      public Department_List(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
         return this.http.post(API_URL + 'Department_List', Info, {headers: this.headers })
         .pipe( map(response => response), catchError(error => of(error)));
      } else {
        return this.ValidateEveryRequest();
     }
      ...
      public Department_SimpleList(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
         return this.http.post(API_URL + 'Department_SimpleList', Info, {headers: this.headers })
         .pipe( map(response => response),  catchError(error => of(error)));
      } else {
        return this.ValidateEveryRequest();
     }
      ...
      public Department_Update(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
         return this.http.post(API_URL + 'Department_Update', Info, {headers: this.headers })
         .pipe( map(response => response), catchError(error => of(error)));
      } else {
        return this.ValidateEveryRequest();
     }
      ...
      public Department_Delete(Info: any): Observable<any[]> {
        if (this.Service.If_LoggedIn()) {
          this.headers.set('Authorization', atob(sessionStorage.getItem('SessionToken')));
          sessionStorage.setItem('SessionKey', btoa(Date()));
         return this.http.post(API_URL + 'Department_Delete', Info, {headers: this.headers })
         .pipe( map(response => response),  catchError(error => of(error)));
      } else {
        return this.ValidateEveryRequest();
     }
