...
export class ModelContactroleCrmsettingsComponent implements OnInit {
   ...
   ngOnInit() {
      ...
      // If Create New Contact Role
         if (this.Type === 'Create') {
            this.Form = new FormGroup({
               Contact_Role: new FormControl('', Validators.required),
      ...
      // If Edit New Contact Role
         if (this.Type === 'Edit') {
            this.Form = new FormGroup({
               Contact_Role: new FormControl(this.Data.Contact_Role, Validators.required),
         ...
         if (this.Form.valid) {
            ...
            this.Service.Contact_Role_Create({'Info': Info}).subscribe( response => {
               ...
               if (response['status'] === 200 && ReceivingData.Status) {
                  ...
                  this.onClose.next({Status: false, Message: 'Contact Role Query Error!'});
                  this.bsModalRef.hide();
